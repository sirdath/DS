...
## Why this matters more than any other strategy call
...
### 1. Neumeier's Onlyness sentence
> *"DS2 is the **only** [category] that [unique attribute] for [best-fit customer] in the [market context]."*

Write 10 drafts. Throw out the safe ones. The one that scares you a little is the right one.

### 2. Dunford's 5 components
For each candidate wedge below:
| Question | Force yourself to answer |
|---|---|
| Competitive alternatives | What does the customer pick if DS2 doesn't exist? (Usually: "Hire freelancers," "Use the in-house junior team," "Do nothing for six more months.") |
| Unique attributes | What does DS2 have that the alternatives don't? |
| Value | What outcome does the customer feel? |
| Best-fit customer | Who is this *most* true for? |
| Market category | Which existing category best frames you? Or invent one. |
...
### 4. The 7-second test
If a stranger lands on the homepage, within 7 seconds can they say:
- What you do
- Who specifically for
- Why you (not anyone else)

If yes, the wedge is sharp enough. If no, keep cutting.
...
| Component | Value |
|---|---|
| Competitive alternatives | Hire a CTO too early; spec-blind agencies; freelancer collectives |
| Unique attributes | Challenge-first method *applied to spec*; senior-only; build-capable after the audit |
| Value | Saves 3–6 months of wrong-spec building; the V1 actually ships |
| Best-fit customer | Funded founders, no engineering team yet, technical co-founder optional |
...
| Component | Value |
|---|---|
| Competitive alternatives | Full rewrite by current team (rarely happens); hire a new CTO; "we'll get to it" |
| Unique attributes | Senior delivery (no juniors poking the legacy code); challenge-first diagnosis before rebuild; build-capable |
| Value | Stops the slow bleed of velocity + risk; team gets its confidence back |
| Best-fit customer | €5–50M ARR B2B SaaS, post-CTO-departure or post-acquisition |
| Category | "Code rescue" / "technical due diligence + remediation" |

**Pros**: Clear urgency (the team is *afraid*). Premium pricing easy. Strong proof loop (before/after measurable). Bigger contracts than A.
...
| Component | Value |
|---|---|
| Competitive alternatives | Maintain it themselves badly; let it die; rebuild from scratch (expensive) |
...
| Component | Value |
|---|---|
| Competitive alternatives | Big-4 AI practices; AI-as-magic agencies; do nothing |
| Unique attributes | Challenge-first (the antidote to AI snake-oil); senior; full build |
| Value | Real ROI in 90 days from one focused AI implementation, not a "transformation" |
| Best-fit customer | €20M+ revenue, traditional industry (manufacturing / logistics / retail / pro services), CEO-led decision |
...
| Component | Value |
|---|---|
| Competitive alternatives | Athens agencies (don't speak the family); London agencies (don't speak Greek); the founder's nephew |
| Unique attributes | Bilingual; understands family-business politics; challenge-first; full digital build |
| Value | Stops the family-business "we'll just have our nephew do it" trap; international-grade digital that's culturally fluent |
| Best-fit customer | Greek family-run FMCG / hospitality / wellness brands trying to go international |
...
| Distribution path clear | 3 | 3 | 3 | 3 | 4 |
| Proof loop fast | 3 | 4 | 4 | 3 | 4 |
| Market size sufficient | 4 | 5 | 3 | 5 | 2 |
...
1. **Pressure-test these five** in a working session with Stelios. Add or kill candidates. Score "founder energy."
2. **Pick one primary + one optional secondary**. (E often makes sense as a secondary alongside A, B, or C.)
3. **Run the chosen wedge through the Onlyness sentence + Dunford 5-component exercise** until the sentence is sharp.
4. **Audit the homepage against the 7-second test** for the new wedge.
5. **Trigger the [02 playbook](02-consulting-marketing-playbook.md) 90-day plan** (manifesto essay → 1-pager → 1 case study → POV cadence → bands).

> Want to pressure-test this with multiple AI perspectives? The `llm-council` skill is built for exactly this kind of high-stakes positioning call.
