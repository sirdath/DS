...
const en: Dict = {
  ...
  hero: {
    ...
    book: { title: "How can we help?", role: "Founders · Athens & London", cta: "Start your brief", sub: "CLICK ME · QUICK RESPONSE", draft: "Hi, I'd like to book a 15-minute intro call." },
  },
  services: {
  ...
  about: {
    ...
    scrollbook: [
      ...
      },
      {
        id: "gap",
        eyebrow: "The gap",
        title: "Serious work. Outdated tools.",
        body: "Real businesses run on systems that quietly hold them back: outdated tools, manual processes, software nobody was properly trained on. Left alone, the gap compounds.",
      },
      {
        id: "dimitris",
        eyebrow: "Engineering & Data · London",
        title: "Dimitris",
        body: "Good engineering is what lets a business actually trust its own systems. He brings the technical core, architecture, data systems, automation and applied AI, held to the standard of a more demanding market.",
      },
      {
        id: "stelios",
        eyebrow: "Consulting & Strategy · Athens",
        title: "Stelios",
        body: "Believes structure and discipline are what make good ideas actually work. He brings business structure, operating discipline and a clear read of the Greek market.",
      },
      {
        id: "ds2",
        eyebrow: "Why DS2",
        title: "Two disciplines, one team.",
        body: "Engineering depth and consulting discipline, with real proximity to the Greek market. That combination is what makes the difference for the businesses we work with.",
      },
    ],
    missionK: "Mission",
...
const el: Dict = {
  ...
  hero: {
    tag1: "Συμβουλευτική",
    tag2: "Ψηφιακών Λύσεων",
    heroTitle: "Ψηφιακές λύσεις, χτισμένες ",
    heroTitleEm: "με δική μας ευθύνη, από την αρχή ως το τέλος.",
    ...
    what: "Τι κάνουμε",
    tags: ["Ιστοσελίδες & Ηλεκτρονικά καταστήματα", "Αυτοματισμοί & ΤΝ", "Δεδομένα & Προβλέψεις", "Λύσεις κατά παραγγελία"],
    build: ["Ιστοσελίδες", "Αυτοματισμοί", "Ενσωμάτωση ΤΝ"],
    buildLabel: "Τι φτιάχνουμε",
    book: { title: "Πώς μπορούμε να βοηθήσουμε;", role: "Ιδρυτές · Αθήνα & Λονδίνο", cta: "Ξεκινήστε το brief", sub: "ΚΑΝΤΕ ΚΛΙΚ · ΓΡΗΓΟΡΗ ΑΠΑΝΤΗΣΗ", draft: "Γεια σας, θα ήθελα να κλείσω μια εισαγωγική κλήση 15 λεπτών." },
  },
  services: {
    ...
    cats: [
      {
        ...
        items: [
          ...
          { name: "Ηλεκτρονικά καταστήματα", detail: "Πουλήστε online με εύκολη ολοκλήρωση αγοράς. Με έτοιμο σχέδιο για καταστήματα ρούχων βγαίνετε online γρήγορα." },
          ...
          { name: "Προϊόντα SaaS", detail: "Λογισμικό με συνδρομή, από την πρώτη οθόνη ως τη χρέωση και την ένταξη των χρηστών." },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Διαδραστικά newsletters", detail: "Κινούμενα newsletters που οι πελάτες σας πραγματικά διαβάζουν — αναλαμβάνουμε και την αποστολή. Σε ανάπτυξη." },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Εσωτερικά εργαλεία & dashboards", detail: "Οι πίνακες διαχείρισης που εύχεται να είχε η ομάδα σας." },
  ...
  engage: {
    ...
    tags: { included: "περιλαμβάνεται", none: "δ/υ", addon: "προαιρετικό" },
  ...
  founders: {
    ...
    sub: "Όταν μιλάτε με τη DS2, μιλάτε με έναν από τους δύο. Δεν σας περνάμε ποτέ σε νεότερα στελέχη, όσο μεγάλο κι αν γίνει το έργο.",
    role: "Ιδρυτής",
  ...
  how: {
    ...
    beats: [
      { n: "01", title: "Διάγνωση και αμφισβήτηση", body: "Αξιολογούμε τι δουλεύει, τι όχι, και τι θα κάναμε διαφορετικά, ακόμη κι ενάντια στο brief που φέρατε." },
      ...
      { n: "04", title: "Παύση απόφασης", body: "«Δεν χρειάζεται να αποφασίσετε τώρα. Με την ησυχία σας, ευχαρίστως προχωράμε όπως προτιμάτε.»" },
    ],
  ...
  footer: {
    copyright: "© 2026 DS2, Συμβουλευτική Ψηφιακών Λύσεων · Αθήνα · Λονδίνο",
    services: "Υπηρεσίες",
    portfolio: "Έργα",
    about: "Σχετικά",
    home: "Αρχική",
    tools: "Εργαλεία",
    headline: "Ψηφιακές λύσεις, χτισμένες με δική μας ευθύνη, από την αρχή ως το τέλος.",
    navLabel: "Πλοήγηση",
  ...
  about: {
    ...
    title: "Δύο ιδρυτές από την Αθήνα που χτίζουν αυτό που ",
    titleEm: "έλειπε",
    ...
    blocks: [
      ...
      },
      {
        ...
        p: "Η Αθήνα κινείται πιο αργά στην τεχνολογία απ’ όσο θα έπρεπε, και αυτό το κενό μεγαλώνει. Αν μείνει έτσι, γίνεται πραγματικό μειονέκτημα για τις επιχειρήσεις εδώ, όχι σε κάποιο μακρινό μέλλον, αλλά μέσα στα επόμενα χρόνια.",
      },
      {
        k: "03 · Γιατί η DS2",
    ...
    scrollbook: [
      ...
      },
      {
        id: "gap",
        eyebrow: "Το κενό",
        title: "Σοβαρή δουλειά. Απαρχαιωμένα εργαλεία.",
        body: "Πραγματικές επιχειρήσεις στηρίζονται σε συστήματα που αθόρυβα τις κρατούν πίσω: απαρχαιωμένα εργαλεία, χειροκίνητες διαδικασίες, λογισμικό που κανείς δεν εκπαιδεύτηκε σωστά να χρησιμοποιεί. Αφημένο μόνο του, το κενό μεγαλώνει.",
      },
      {
        id: "dimitris",
        eyebrow: "Μηχανική & Δεδομένα · Λονδίνο",
        title: "Δημήτρης",
        body: "Η καλή μηχανική είναι αυτή που κάνει μια επιχείρηση να εμπιστεύεται πραγματικά τα δικά της συστήματα. Ο Δημήτρης φέρνει τον τεχνικό πυρήνα, αρχιτεκτονική, συστήματα δεδομένων, αυτοματισμούς και εφαρμοσμένη ΤΝ, σε ένα επίπεδο που ορίζει μια πιο απαιτητική αγορά.",
      },
      {
        id: "stelios",
        eyebrow: "Συμβουλευτική & Στρατηγική · Αθήνα",
        title: "Στέλιος",
        body: "Πιστεύει ότι η δομή και η πειθαρχία είναι αυτά που κάνουν τις καλές ιδέες να λειτουργούν πραγματικά. Φέρνει επιχειρηματική δομή, πειθαρχία στη λειτουργία και καθαρή ανάγνωση της ελληνικής αγοράς.",
      },
      {
        id: "ds2",
        eyebrow: "Γιατί η DS2",
        title: "Δύο ειδικότητες, μία ομάδα.",
        body: "Τεχνικό βάθος και συμβουλευτική μεθοδικότητα, με πραγματική εγγύτητα στην ελληνική αγορά. Αυτός ο συνδυασμός είναι που κάνει τη διαφορά για τις επιχειρήσεις με τις οποίες συνεργαζόμαστε.",
      },
    ],
    missionK: "Αποστολή",
  ...
  portfolio: {
    ...
    titleEm: "ειλικρινά.",
    sub: "Πρώτες δουλειές, με όνομα όπου ο πελάτης δεν έχει πρόβλημα να αναφερθεί. Λέμε τι κάναμε, και τι δεν κάναμε.",
    cases: [
      {
        tag: "Ιστοσελίδες",
  ...
  toolsTeaser: {
    ...
    titleEm: "ως υπηρεσία.",
    sub: "Οι υπηρεσίες μας είναι φτιαγμένες για μικρομεσαίες επιχειρήσεις. Για ομίλους, αλυσίδες και scale-ups τρέχουμε τα εργαλεία ευφυΐας αποφάσεων της DS2: συνεχής πληροφόρηση για αγορά, φήμη και τοποθεσίες, παραδομένη ως αποφάσεις που η ομάδα σας μπορεί να υλοποιήσει.",
  ...
  tools: {
    ...
    videoSoon: "Σύντομο βίντεο επίδειξης, έρχεται σύντομα.",
    items: [
      {
        slug: "competitor-watch",
        status: "early",
        ...
        tagline: "Ο εκατόφθαλμος φύλακας. Παρακολουθούμε τους ανταγωνιστές σας, για να μη χρειάζεται να το κάνετε εσείς.",
        ...
        features: [
          { name: "Εβδομαδιαία ενημέρωση", detail: "Ένα σύντομο brief κάθε Δευτέρα, γραμμένο για ιδιοκτήτη, όχι για αναλυτή. Μόνο οι αλλαγές που έχουν σημασία." },
          { name: "Τιμές & προσφορές", detail: "Νέα πακέτα, εκπτώσεις και αλλαγές σε μενού ή τιμές, εντοπισμένες την εβδομάδα που συμβαίνουν." },
          { name: "Παρακολούθηση κριτικών", detail: "Τι επαινούν και τι κατακρίνουν οι πελάτες στους αντιπάλους σας, συνοψισμένο." },
          { name: "Ορατότητα στην αναζήτηση", detail: "Ποιος εμφανίζεται πού για τις αναζητήσεις που σας φέρνουν πελάτες, με παρακολούθηση στον χρόνο." },
        ],
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Πραγματική ανάλυση συναισθήματος, και στα ελληνικά", detail: "Τι επαινούν οι επισκέπτες και τι σας κοστίζει αστέρια, και στις δύο γλώσσες." },
          { name: "Προσχέδια απαντήσεων", detail: "Προσεγμένες απαντήσεις για κάθε κριτική, στη δική σας φωνή, έτοιμες για έγκριση." },
          { name: "Μηνιαία αναφορά τάσεων", detail: "Η πορεία της βαθμολογίας και τα τρία επόμενα πράγματα που αξίζει να διορθώσετε, ταξινομημένα κατά επίδραση." },
        ],
      ...
      },
      {
        ...
        desc: "Γεωχωρική μελέτη για το πού να ανοίξετε το επόμενο σημείο: ενδείξεις κίνησης, πυκνότητα ανταγωνισμού, δημογραφικά και προσβασιμότητα, βαθμολογημένα δρόμο προς δρόμο. Πάνω στις ίδιες μεθόδους με τις οποίες μετατρέψαμε δύο εκατομμύρια σημεία ενδιαφέροντος σε δίκτυο σε παραγωγική λειτουργία.",
        roiBody: "Η μίσθωση ενός κεντρικού καταστήματος είναι δεκαετής δέσμευση επταψήφιου κόστους που κρίνεται σε λίγες εβδομάδες. Οι μεγάλες εταιρείες χρεώνουν €25.000+ για τη μελέτη που μειώνει το ρίσκο. Παραδίδουμε εξίσου τεκμηριωμένη απάντηση σε εβδομάδες, σε κλάσμα της τιμής, με το σκεπτικό ορατό.",
        stats: [
      ...
      },
      {
        slug: "ai-receptionist",
        status: "soon",
        name: "Ψηφιακή υποδοχή με ΤΝ",
        role: "Xenia",
        benefit: "Κάθε αίτημα απαντημένο, κάθε ραντεβού κερδισμένο. Και στις 3 τα ξημερώματα.",
        ...
        roiBody: "Περίπου το ένα τρίτο των αιτημάτων έρχεται εκτός ωραρίου, και σε κλίμακα πολλών μονάδων τα αναπάντητα αιτήματα είναι μια αθόρυβη, μόνιμη διαρροή εσόδων. Η εικοσιτετράωρη κάλυψη υποδοχής κοστίζει μισθούς· αυτό κοστίζει κλάσμα ενός.",
        stats: [
          { value: "24/7", label: "κάθε αίτημα απαντημένο, σε δύο γλώσσες" },
          { value: "~1/3", label: "των αιτημάτων έρχεται εκτός ωραρίου" },
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Παλαιότητα οφειλών με μια ματιά", detail: "Τρέχον, 1-30, 31-60, 61-90 και 90+, με την αξία σε ευρώ σε κάθε κατηγορία." },
      ...
      },
      {
        ...
        roiBody: "Οι περισσότεροι έλεγχοι σας δίνουν μια αναφορά 200 γραμμών που δεν διαβάζει κανείς. Ο Aegis σας δίνει τέσσερις βαθμολογίες, τα λίγα ζητήματα που πραγματικά σας κοστίζουν πελάτες ή παραβιάζουν την Ευρωπαϊκή Πράξη Προσβασιμότητας, και τη σειρά για να τα διορθώσετε.",
        stats: [
          { value: "4 σκορ", label: "ταχύτητα, προσβασιμότητα, SEO, βέλτιστες πρακτικές" },
          { value: "€100k", label: "το πρόστιμο της Πράξης Προσβασιμότητας του οποίου μειώνετε τον κίνδυνο" },
      ...
      },
      {
        ...
        name: "Μνήμη ΤΝ",
        role: "NeuroVault",
        benefit: "Δώστε σε κάθε πράκτορα ΤΝ μια ανθεκτική, ιδιωτική μνήμη, ώστε να σταματήσει να ξεχνά.",
        tagline: "Το θησαυροφυλάκιο της μνήμης. Ένα local-first επίπεδο γνώσης από το οποίο κάθε πράκτορας ΤΝ μπορεί να ανακαλεί.",
        ...
        roiBody: "Κάθε εργαλείο ΤΝ που τρέχουμε παραμένει οξυδερκές επειδή θυμάται. Το NeuroVault είναι το επίπεδο μνήμης από κάτω τους, και το κάναμε open source: χωρίς λογαριασμό, χωρίς telemetry, χωρίς χρέωση φιλοξενίας μνήμης.",
        stats: [
        ...
        audience: "Ομάδες και δημιουργοί που τρέχουν πράκτορες ΤΝ οι οποίοι πρέπει να θυμούνται πλαίσιο ανάμεσα σε συνεδρίες και εργαλεία.",
      ...
      },
      {
        ...
        role: "Iris",
        benefit: "Μετατρέψτε μια λίστα email σε κανάλι που οι πελάτες πραγματικά ανοίγουν και στο οποίο ενεργούν.",
        tagline: "Η αγγελιαφόρος των θεών. Newsletter που οι πελάτες σας ανοίγουν, πατούν και στα οποία απαντούν.",
        ...
        stats: [
          // Kept short on purpose: the longer wording measured 466.8px against a
          // 459px stat pill on /tools, which broke "1st-party" across two lines
          // and made this the only 58px pill among nine 37px ones.
          { value: "1st-party", label: "κοινό δικό σας, όχι νοικιασμένο από πλατφόρμα" },
      ...
      },
      {
        ...
        tagline: "Ο σκαραβαίος που μετατρέπει ακατέργαστες σελίδες σε τακτοποιημένα δεδομένα. Ένας scraper που δουλεύει απευθείας από το screenshot και διαβάζει τη σελίδα όπως ένας άνθρωπος.",
        ...
        audience: "Ομάδες που χρειάζονται δεδομένα παγιδευμένα σε ιστότοπους, αγγελίες, καταλόγους, ευρετήρια, σελίδες ανταγωνιστών, μετατρεμμένα σε έναν καθαρό, επαληθεύσιμο πίνακα.",
  ...
  panel: {
    ...
    chips: [
      ...
      { label: "Δεν είμαστε σίγουροι, ας τα πούμε", draft: "Γεια σας DS2, δεν ξέρουμε ακόμη τι ακριβώς χρειαζόμαστε. Η κατάστασή μας: " },
    ],
