...
const CTA = {
  ...
  el: {
    ...
    body: 'Σκέφτεστε κάτι αντίστοιχο για την επιχείρησή σας; Δουλεύουμε καλύτερα όταν μπορούμε να είμαστε ειλικρινείς από νωρίς, ακόμη κι αν αυτό σημαίνει να αμφισβητήσουμε την αρχική ιδέα. Πείτε μας τι σχεδιάζετε και θα σας πούμε τι δημιουργεί ρίσκο, τι πρέπει να κοστίζει και τι θα κάναμε διαφορετικά.',
    button: 'Μιλήστε μας',
