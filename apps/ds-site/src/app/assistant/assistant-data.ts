  ...
  el: {
    goal: {
      ...
      options: [
        ...
        { value: "time", label: "Περισσότερος χρόνος στην ομάδα", note: "Αυτοματισμοί, ΤΝ και λιγότερη επανάληψη" },
    ...
    branches: {
      customers: {
        ...
        services: { id: "services", eyebrow: "02 · Η ευκαιρία", title: "Πού πρέπει να βελτιωθεί η εμπειρία του πελάτη;", help: "Επιλέξτε έως τρία. Με βάση αυτά διαμορφώνουμε την επόμενη ερώτηση.", summaryLabel: "Ευκαιρίες εμπειρίας πελάτη", type: "limit", limit: 3, context: "Επειδή επιλέξατε ανάπτυξη πελατών", options: [
          { value: "website", label: "Ιστοσελίδα ή αναβάθμιση παρουσίας", note: "Αξιόπιστη δημόσια εικόνα που μετατρέπει" }, { value: "shop", label: "Ηλεκτρονικό κατάστημα", note: "Προϊόντα, ολοκλήρωση αγοράς και πληρωμές" }, { value: "booking", label: "Σύστημα κρατήσεων", note: "Διαθεσιμότητα, ραντεβού και πληρωμή" }, { value: "platform", label: "Πλατφόρμα πελατών", note: "Χρήσιμη εμπειρία με σύνδεση χρηστών" }, { value: "mobile", label: "Εφαρμογή κινητού", note: "Ένας άμεσος χώρος επιστροφής πελατών" }, { value: "unsure", label: "Βοηθήστε με να επιλέξω", note: "Γνωρίζω το αποτέλεσμα, όχι τη λύση" },
        ] },
        diagnosis: { id: "diagnosis", eyebrow: "03 · Τι συμβαίνει τώρα", title: "Τι εμποδίζει την ανάπτυξη;", help: "Επιλέξτε την πιο κοντινή απάντηση. Δεν χρειάζεται να ταιριάζει απόλυτα.", summaryLabel: "Τρέχον πρόβλημα ανάπτυξης", type: "single", autoAdvance: true, options: [
        ...
        outcomes: { id: "outcomes", eyebrow: "04 · Ένα καλό αποτέλεσμα", title: "Τι πρέπει να πετύχει πρώτα;", help: "Επιλέξτε τα δύο αποτελέσματα που έχουν τη μεγαλύτερη σημασία.", summaryLabel: "Αποτελέσματα ανάπτυξης", type: "limit", limit: 2, options: [
        ...
        detailsTitle: "Τι πρέπει να καταλάβουν, να νιώσουν ή να κάνουν οι πελάτες;", detailsHelp: "Ένα πραγματικό παράδειγμα είναι πιο χρήσιμο από τεχνικές προδιαγραφές.", detailsPlaceholder: "Για παράδειγμα: οι πελάτες τηλεφωνούν επειδή δεν βλέπουν διαθεσιμότητα, η τωρινή ιστοσελίδα δείχνει την επιχείρησή μας μικρότερη απ’ ό,τι είναι, και θέλουμε περισσότερες άμεσες κρατήσεις…",
      },
      time: {
        label: "Περισσότερος χρόνος στην ομάδα",
        services: { id: "services", eyebrow: "02 · Η ευκαιρία", title: "Πού επαναλαμβάνεται η δουλειά;", help: "Επιλέξτε έως τρία. Η επόμενη ερώτηση εστιάζει στη ροή εργασίας σας.", summaryLabel: "Λειτουργικές ευκαιρίες", type: "limit", limit: 3, context: "Επειδή επιλέξατε χρόνο και αυτοματισμό", options: [
          { value: "automation", label: "Αυτοματισμός ροών", note: "Σύνδεση εργαλείων και λιγότερη διαχειριστική δουλειά" }, { value: "receptionist", label: "Ψηφιακή υποδοχή με ΤΝ", note: "Απαντήσεις και κρατήσεις 24/7" }, { value: "chatbot", label: "Chatbot ιστοσελίδας", note: "Απαντήσεις από τα πραγματικά στοιχεία σας" }, { value: "agents", label: "Πράκτορες ΤΝ με την ώρα", note: "Έρευνα, καταχώριση και υπενθυμίσεις" }, { value: "loyalty", label: "Κάρτες πιστότητας & εργαλεία καταστήματος", note: "Ψηφιακές κάρτες, κριτικές και ψηφιακά μενού" }, { value: "unsure", label: "Βοηθήστε με να βρω την ευκαιρία", note: "Ξέρω ότι κάπου χάνεται χρόνος" },
        ] },
        diagnosis: { id: "diagnosis", eyebrow: "03 · Τι συμβαίνει τώρα", title: "Ποια πρόταση σας θυμίζει περισσότερο την καθημερινότητα;", help: "Επιλέξτε αυτό που θα θέλατε να μην ξανακάνετε.", summaryLabel: "Τρέχον λειτουργικό πρόβλημα", type: "single", autoAdvance: true, options: [
          { value: "repetition", label: "Επαναλαμβάνουμε την ίδια διαχειριστική δουλειά κάθε μέρα", note: "Αντιγραφή, ενημέρωση και καταχώριση" }, { value: "enquiries", label: "Χάνονται αιτήματα πελατών", note: "Δεν απαντάμε άμεσα ή εκτός ωραρίου" }, { value: "disconnected", label: "Τα εργαλεία μας δεν επικοινωνούν", note: "Οι πληροφορίες είναι παντού" }, { value: "reporting", label: "Οι αναφορές αργούν πολύ", note: "Οι απαντήσεις εξαρτώνται από υπολογιστικά φύλλα" }, { value: "scale", label: "Η ανάπτυξη δημιουργεί πίεση", note: "Περισσότερη δουλειά σημαίνει περισσότερα λάθη" },
        ] },
        outcomes: { id: "outcomes", eyebrow: "04 · Ένα καλό αποτέλεσμα", title: "Τι πρέπει να επιστρέψει το σύστημα;", help: "Επιλέξτε τα δύο αποτελέσματα με τη μεγαλύτερη αξία για την επιχείρηση.", summaryLabel: "Λειτουργικά αποτελέσματα", type: "limit", limit: 2, options: [
          { value: "hours", label: "Ώρες κάθε εβδομάδα", note: "Λιγότερη επαναληπτική εργασία" }, { value: "accuracy", label: "Λιγότερα λάθη", note: "Αξιόπιστες διαδικασίες" }, { value: "speed", label: "Ταχύτερη εξυπηρέτηση", note: "Γρήγορες απαντήσεις και υπενθυμίσεις" }, { value: "always-on", label: "Απόκριση 24/7", note: "Κανένα αίτημα εκτός ωραρίου δεν χάνεται" }, { value: "control", label: "Περισσότερος έλεγχος", note: "Ξέρετε τι συμβαίνει χωρίς κυνηγητό" },
        ] },
        detailsTitle: "Περιγράψτε τη δουλειά που θα θέλατε να γίνεται μόνη της.", detailsHelp: "Τι την ξεκινά, ποιος εμπλέκεται και πού καθυστερεί;", detailsPlaceholder: "Για παράδειγμα: κάθε κράτηση έρχεται με email, κάποιος την περνά σε ημερολόγιο, απαντά χειροκίνητα και ετοιμάζει μια εβδομαδιαία αναφορά…",
      },
      product: {
        label: "Μια νέα ιδέα",
        services: { id: "services", eyebrow: "02 · Η ευκαιρία", title: "Τι είδους πράγμα φαντάζεστε;", help: "Επιλέξτε έως τρία. Το «εντελώς custom» είναι απολύτως χρήσιμη απάντηση.", summaryLabel: "Κατεύθυνση προϊόντος", type: "limit", limit: 3, context: "Επειδή επιλέξατε νέο προϊόν ή ιδέα", options: [
          { value: "crm", label: "Custom CRM", note: "Κέντρο πωλήσεων και πελατών στα μέτρα σας" }, { value: "marketplace", label: "Πλατφόρμα αγοράς", note: "Σύνδεση δύο πλευρών μιας αγοράς" }, { value: "internal", label: "Εσωτερικό εργαλείο ή dashboard", note: "Το σύστημα διαχείρισης που χρειάζεται η ομάδα" }, { value: "saas", label: "SaaS ή web πλατφόρμα", note: "Συνδρομητικό προϊόν με σύνδεση χρηστών" }, { value: "mobile", label: "Εφαρμογή κινητού", note: "Εστιασμένη iOS και Android εμπειρία" }, { value: "custom", label: "Εντελώς custom", note: "Δεν ταιριάζει σε υπάρχουσα κατηγορία" },
        ] },
        diagnosis: { id: "diagnosis", eyebrow: "03 · Πού βρίσκεται η ιδέα", title: "Πόσο χειροπιαστή είναι σήμερα;", help: "Έτσι καταλαβαίνουμε αν ξεκινάμε από στρατηγική, design ή build.", summaryLabel: "Τρέχον στάδιο προϊόντος", type: "single", autoAdvance: true, options: [
          { value: "idea", label: "Είναι μια ιδέα στο μυαλό μου", note: "Η ευκαιρία είναι πιο καθαρή από το προϊόν" }, { value: "rough", label: "Έχουμε πρόχειρες λειτουργίες ή σκίτσα", note: "Υπάρχει μια μορφή που χρειάζεται αμφισβήτηση" }, { value: "prototype", label: "Υπάρχει πρωτότυπο", note: "Χρειάζεται δοκιμή, βελτίωση ή μετάβαση σε παραγωγή" }, { value: "replace", label: "Πρέπει να αντικατασταθεί κάτι", note: "Το υπάρχον εργαλείο δεν ταιριάζει πλέον" }, { value: "ready", label: "Έχουμε σαφείς προδιαγραφές", note: "Είμαστε σχεδόν έτοιμοι για build" },
        ] },
        outcomes: { id: "outcomes", eyebrow: "04 · Ένα καλό αποτέλεσμα", title: "Τι έχει μεγαλύτερη σημασία για την πρώτη έκδοση;", help: "Επιλέξτε δύο. Τα καλά προϊόντα διαμορφώνονται από συνειδητούς συμβιβασμούς.", summaryLabel: "Προτεραιότητες προϊόντος", type: "limit", limit: 2, options: [
        ...
        detailsTitle: "Περιγράψτε την ιδέα σαν να τη λέγατε σε έναν πελάτη.", detailsHelp: "Για ποιον είναι, τι κάνει και γιατί έχει αξία;", detailsPlaceholder: "Για παράδειγμα: ένα marketplace όπου τοπικοί αθλητικοί σύλλογοι δημοσιεύουν κενές ώρες και οι παίκτες κάνουν κράτηση και πληρωμή σε ένα σημείο…",
      },
      clarity: {
        label: "Καθαρότερη εικόνα της επιχείρησης",
        services: { id: "services", eyebrow: "02 · Η ευκαιρία", title: "Ποιες απαντήσεις είναι δύσκολο να βρείτε σήμερα;", help: "Επιλέξτε έως τρία. Στη συνέχεια εστιάζουμε πιο συγκεκριμένα στο πρόβλημα της πληροφορίας.", summaryLabel: "Ευκαιρίες δεδομένων", type: "limit", limit: 3, context: "Επειδή επιλέξατε καθαρότερα δεδομένα", options: [
          { value: "dashboard", label: "Business dashboard", note: "Μία χρήσιμη εικόνα της απόδοσης" }, { value: "forecast", label: "Προβλέψεις", note: "Καθαρότερη εικόνα για το επόμενο βήμα" }, { value: "marketing", label: "Marketing dashboard", note: "Καμπάνιες, leads και αποτελέσματα" }, { value: "competitors", label: "Παρακολούθηση ανταγωνισμού", note: "Πώς κινείται η αγορά" }, { value: "pipeline", label: "Ροές δεδομένων", note: "Σύνδεση και καθαρισμός πληροφοριών" }, { value: "unsure", label: "Βοηθήστε με να το διαγνώσω", note: "Οι αριθμοί υπάρχουν αλλά δεν είναι χρήσιμοι" },
        ] },
        diagnosis: { id: "diagnosis", eyebrow: "03 · Τι συμβαίνει τώρα", title: "Πού χάνεται η καθαρή εικόνα;", help: "Επιλέξτε την περιγραφή που πλησιάζει περισσότερο τη σημερινή πραγματικότητα.", summaryLabel: "Τρέχον πρόβλημα πληροφορίας", type: "single", autoAdvance: true, options: [
          { value: "scattered", label: "Τα δεδομένα είναι διάσπαρτα", note: "Κάθε εργαλείο έχει άλλη αλήθεια" }, { value: "slow", label: "Οι αναφορές αργούν", note: "Οι απαντήσεις έρχονται αφού περάσει η στιγμή" }, { value: "gut", label: "Οι αποφάσεις βασίζονται στο ένστικτο", note: "Δεν βλέπουμε γρήγορα τις αποδείξεις" }, { value: "future", label: "Δεν βλέπουμε τι έρχεται", note: "Ζήτηση, έσοδα ή φόρτος εργασίας είναι αβέβαια" }, { value: "market", label: "Δεν βλέπουμε καθαρά την αγορά", note: "Δύσκολη η παρακολούθηση ανταγωνιστών και ευκαιριών" },
        ] },
        outcomes: { id: "outcomes", eyebrow: "04 · Ένα καλό αποτέλεσμα", title: "Τι πρέπει να είναι προφανές με μία ματιά;", help: "Επιλέξτε τις δύο απαντήσεις που θα κοιτάζατε πιο συχνά.", summaryLabel: "Αποτελέσματα αποφάσεων", type: "limit", limit: 2, options: [
          { value: "performance", label: "Πώς αποδίδει η επιχείρηση", note: "Οι λίγοι αριθμοί που έχουν σημασία" }, { value: "next", label: "Τι πιθανότατα ακολουθεί", note: "Πρόβλεψη ζήτησης, εσόδων ή φόρτου εργασίας" }, { value: "attention", label: "Τι χρειάζεται προσοχή τώρα", note: "Κίνδυνοι και ευκαιρίες" }, { value: "marketing", label: "Τι παράγει το marketing", note: "Σύνδεση της δραστηριότητας με leads και πωλήσεις" }, { value: "market", label: "Πώς συγκρινόμαστε με την αγορά", note: "Ανταγωνιστές, τιμές και κίνηση" },
        ] },
        detailsTitle: "Ποια είναι η ερώτηση που δεν παίρνει ποτέ ξεκάθαρη απάντηση;", detailsHelp: "Ένα συγκεκριμένο, πραγματικό παράδειγμα είναι πιο χρήσιμο από μια γενική περιγραφή.", detailsPlaceholder: "Για παράδειγμα: η ομάδα κάνει τέσσερις συναντήσεις την εβδομάδα μόνο για να αποφασίσει τι θα κάνει μετά, και οι μισές τελειώνουν με «ας τα ξαναπούμε αργότερα»…",
      },
    } satisfies Record<GoalKey, Branch>,
    common: {
      business: { id: "business", title: "Λίγο πλαίσιο αλλάζει την πρόταση.", help: "Μόνο το όνομα και ο κλάδος είναι υποχρεωτικά.", summaryLabel: "Στοιχεία επιχείρησης", type: "fields", fields: [
        { id: "company", label: "Επιχείρηση ή έργο", type: "text", required: true }, { id: "industry", label: "Κλάδος", type: "text", required: true }, { id: "website", label: "Τρέχουσα ιστοσελίδα", type: "url" },
      ] },
      team: { id: "team", title: "Πόσα άτομα έχει η ομάδα σας;", help: "Μετακινήστε το slider. Μας βοηθά να κρίνουμε πολυπλοκότητα, πρόσβαση και handover.", summaryLabel: "Μέγεθος ομάδας", type: "slider", slider: { min: 0, max: 4, defaultValue: 1, values: ["Μόνο εγώ", "2–5 άτομα", "6–15 άτομα", "16–50 άτομα", "Πάνω από 50"], labels: ["Solo", "Μικρή ομάδα", "Αναπτυσσόμενη ομάδα", "Εδραιωμένη ομάδα", "Μεγάλος οργανισμός"], scene: "team", exact: {
        min: 1, max: 51, defaultValue: 1,
        tiers: [
          { min: 1, max: 1, label: "Solo", range: "1" },
        ...
        sceneLabel: "Η ομάδα σας", scrollHint: "Κάντε scroll εδώ για ακριβή αριθμό",
        shortcutsLabel: "Συντομεύσεις μεγέθους ομάδας",
      } } },
      timing: { id: "timing", title: "Πότε θα ήταν χρήσιμο να είναι live;", help: "Δεν υπάρχει λάθος ταχύτητα. Μετακινήστε τον δείκτη σε ό,τι σας φαίνεται ρεαλιστικό.", summaryLabel: "Ιδανικό timing", type: "slider", slider: { min: 0, max: 4, defaultValue: 1, values: ["Διερεύνηση — χωρίς deadline", "Μέσα σε 3 – 6 μήνες", "Μέσα σε 1 – 3 μήνες", "Μέσα σε έναν μήνα", "Όσο πιο σύντομα γίνεται, με υπευθυνότητα"], labels: ["Διερεύνηση", "Αυτό το εξάμηνο", "Αυτό το τρίμηνο", "Αυτόν τον μήνα", "Έτοιμοι τώρα"], scene: "timing" } },
      budget: { id: "budget", title: "Με ποιο εύρος επένδυσης νιώθετε άνετα;", help: "Καθορίζει το πρώτο χρήσιμο scope. Δεν είναι προσφορά ή δέσμευση.", summaryLabel: "Εύρος επένδυσης", type: "slider", slider: { min: 0, max: 5, defaultValue: 0, values: ["Δεν είμαστε σίγουροι", "Κάτω από €500", "€500 – €1.500", "€1.500 – €3.500", "€3.500 – €10.000", "€10.000+"], labels: ["Ας το ορίσουμε", "Εστιασμένη αρχή", "Στέρεο build", "Φιλόδοξο build", "Μεγάλο σύστημα", "Στρατηγική πλατφόρμα"], scene: "budget", sceneLayers: ["Διερεύνηση", "Θεμέλια", "Εμπειρία", "Αυτοματισμός", "Κλίμακα", "Επίβλεψη"] } },
