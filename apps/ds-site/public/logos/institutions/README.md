# Institution logos (expertise marquee)

Drop the OFFICIAL, licensed logo file here and it appears automatically — no
code change. Each slot tries {slug}.svg first, then {slug}.png, then falls back
to a text wordmark.
